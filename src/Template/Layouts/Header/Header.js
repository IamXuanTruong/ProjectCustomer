                    ...
                    <div className='banner_job'>
                        <div className='job1'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29 32" version="1.0" fit="" height="50px" width="50px"
                                preserveAspectRatio="xMidYMid meet" style={{ pointerEvents: "none", 'display': 'inline - block' }}
                        ...
                        <div className='job3'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29 32" version="1.0" fit="" height="50px" width="50px"
                                preserveAspectRatio="xMidYMid meet" style={{ pointerEvents: "none", 'display': 'inline - block' }} fill="rgba(244,67,54,1)">
                                <path
